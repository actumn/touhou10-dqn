...
transform_width = 128
img_channels = 12
batch_size = 64  # batch size for update in exp replay
eps_start = 0.9
eps_end = 0.05
eps_decay = 200
...
death_reward = -200  # at the moment the agent stays dead for two frames, so it will receive this reward twice
reward_in_env = 1  # reward for living in the environment
reward_on_power = 5  # reward for getting power item
reward_on_hit = 1000  # reward for hitting enemy
